...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> buscarData_retirada(@PathVariable String data_retirada) {
		return ResponseEntity.ok(produto.findAllByData_RetiradaContainingIgnoreCase(data_retirada));
	}*/
	...
	public ResponseEntity<List<Produto>> buscarQuantidade(@PathVariable Long quantidade) {
		return ResponseEntity.ok(produto.findAllByQuantidadeContainingIgnoreCase(quantidade));
	}*/
